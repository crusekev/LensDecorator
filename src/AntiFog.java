...
/**
 * AntiFog is a decorator class that extends the abstract class LensDecorator.
 */
public class AntiFog extends LensDecorator
{
    /**
     * AntiFog is a constructor that is passed a Lenses object which is stored.
     *
     * @param lens is a Lenses object.
     */
    public AntiFog(Lenses lens)
    {
        this.lens = lens;
    }
    ...
    {
        return lens.getDescription() + ", A coating that helps prevent your lenses from fogging up during activities such as cooking";
    }
