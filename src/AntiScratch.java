...
/**
 * AntiScratch is a decorator class that extends the abstract class LensDecorator.
 */
public class AntiScratch extends LensDecorator
{
    /**
     * AntiScratch is a constructor that is passed a Lenses object which is stored.
     *
     * @param lens is a Lenses object.
     */
    public AntiScratch(Lenses lens)
    {
        this.lens = lens;
    }
    ...
    {
        return lens.getDescription() + ", A scratch-resistant coating that improves the durability of the lens";
    }
