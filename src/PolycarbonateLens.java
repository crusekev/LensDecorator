...
/**
 * PolycarbonateLens is an undecorated class that extends the Lenses abstract class.
 */
public class PolycarbonateLens extends Lenses
{
    /**
     * PolycarbonateLens is a constructor that sets the proper description.
     */
    public PolycarbonateLens()
    {
        description = "Impact-resistant lens that is great for sports or those who are rough on their glasses";
    }
